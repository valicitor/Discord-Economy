...
class TestGenerateGalaxyMapCommand(unittest.TestCase):
    def setUp(self):
        ...
        neutral = self.POI_repository.get_all()[0]
        neutral.owner_player_id = self.player_profile3.player.player_id
        self.POI_repository.update(neutral)
        ...
        neutral = self.POI_repository.get_all()[2]
        neutral.owner_player_id = self.player_profile1.player.player_id
        self.POI_repository.update(neutral)
