...
class TestEquipmentsSeeder(unittest.TestCase):
    def setUp(self):
        self.equipment_repository = EquipmentRepository(":memory:")  # Use in-memory database for testing
        self.equipment_stat_repository = EquipmentStatRepository(":memory:")  # Use in-memory database for testing
