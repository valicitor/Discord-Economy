...
class TestRacesSeeder(unittest.TestCase):
    ...
    def test_seed_races_and_race_stats_if_empty(self):
        ...
        # Assert
        races = self.default_setup.race_repository.get_all(self.default_setup.server_config.server.server_id)
        race_stats = self.default_setup.race_stat_repository.get_all()
