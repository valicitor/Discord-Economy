...
class GalaxyMapGeneratorHandler:
    ...
    def __init__(self):
        ...
        self.POI_MARKERS = {
            "Capital World":    self.POIMarker("H", "white", 10, 6, 10),
            "Important World":  self.POIMarker("p", "white", 7, 5, 9),
            "Primary World":    self.POIMarker("o", "white", 4, 4, 8),
            "Secondary World":  self.POIMarker("s", "white", 2, 3, 6),
            "Tertiary World":   self.POIMarker("D", "gray", 2, 3, 5),
            "No Marker":        self.POIMarker(None, None, None, 4, 10),
        }

    # -------------------- POI Rendering --------------------
    def _get_poi_marker(self, poi_type: str) -> POIMarker:
        return self.POI_MARKERS.get(poi_type, self.POIMarker("o", "white", 5, 6, 10))
